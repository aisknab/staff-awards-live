  ...
  if (!state) {
    clear(root, h('main', { class: 'display-screen' },
      ...
      h('section', { class: 'display-main' }, h('div', { class: 'display-panel' },
        h('img', { class: 'display-panel-logo', src: '/brand/logos/criteo-logo-white.svg', alt: 'Criteo' }),
  ...
  clear(root,
    ...
    h('main', { class: 'display-screen' },
      h('header', { class: 'display-header' },
        h('div', { class: 'brand-lockup display-brand' },
          h('img', { class: 'brand-logo', src: '/brand/logos/criteo-logo-white.svg', alt: 'Criteo' }),
          h('div', { class: 'brand-event' },
            h('div', { class: 'brand-event-title', text: state.event.title }),
          ),
        ),
